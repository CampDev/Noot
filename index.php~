                ...
                <?php
					...
					foreach ($notebooks['posts'] as $notebook) {
						...
						if (!is_null($content['name'])) {
							echo "<td><a href='index.php?notebook=".$notebook['id']."'>".$content['name']."</a></td>";
							...
							echo "<td><a href='edit.php?notebook=".$notebook['id']."'>".Edit."</a></td>";
							if (!is_null($content['description'])) {
								echo "<td>".$content['description']."</td>";
							}
							else {
							...
							echo "<td style='color: #cd0d00;'><a class='delete' href='task_handler.php?type=delete&id=".$notebook['id']."'><img src='img/delete.png' style='width: 8px;'></a></td>"; 
						}

						
						echo "</tr>";
					}
					echo "</table>					<form align='center' method='post' action='task_handler.php?type=notebook'>
