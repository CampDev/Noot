				...
				<div class='column-3'>
                    <div class='column-3-inner'>
				        <div class="filters" style="max-width: 721px;">
                            ...
                            <a href="index.php?notebook=<?php echo $_GET['notebook']; ?>&note=<?php echo $current_note['post']['id']; ?>&edit=true">Edit</a> | <a href="task_handler.php?type=delete&id=<?php echo $current_note['post']['id']; ?>">Delete</a>
                        </div>
