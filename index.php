...
<html>
	...
	<?php include('header.php'); ?>
			...
			<div class="container">
				...
				elseif (isset($_GET['notebook'])) {
					...
					if ($posts['posts'] != array()) {
						...
						foreach ($posts['posts'] as $note) {
						    ...
						    echo "<td><a href='index.php?notebook=".$_GET['notebook']."&note=".$note['id']."'>".$content['title']."</a>";
                ...
                <div class='column-3-inner'>
				<div class="filters" style="max-width: 721px;">
                <div style="float: left; font-weight: 800;"><?php echo $current_note['post']['content']['title']; ?></div><a href="index.php?notebook=<?php echo $_GET['notebook']; ?>&note=<?php echo $current_note['post']['id']; ?>&edit=true">Edit</a> | <a href="task_handler.php?type=delete&id=<?php echo $current_note['post']['id']; ?>">Delete</a>
                </div>
                <div style="padding: 3%;">
                        <?php echo tent_markdown($current_note['post']['content']['body']); ?>
                </div>
